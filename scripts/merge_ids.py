...
## fX = filenames
## Opens first file in input, separates the ID and domain name, and creates a dictionary (key: id; value: domain)
## A list is made with the other ones. 
##files 3 and 4 are optional and empty by default. 
## The remaining files are opened and if there is an ID already present in the dictionary, the value is appended with the domain from this file
...
## Amending values in a dictionary code obtained from:  https://stackoverflow.com/questions/41825868/update-python-dictionary-add-another-value-to-existing-key
